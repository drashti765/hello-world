<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="AboutUs.aspx.cs" Inherits="AboutUsajax" Title="Blue Bus: About Us" %>
                            ...
                            <tbody>                               
                                <tr>
                                    <td align="left">
                                        <!-- Body Content Starts -->
                                        <p>
                                            <b>Bluebus</b> is a pioneer in the online bus reservation in India which utilizes
                                            the advantages of the internet to provide our clients with the best in bus transportation
                                            services from the comforts of their homes and offices. Bluebus provides real-time
                                            Internet quotations and real-time bus booking services to direct customers, agents
                                            and tour operator partners.
                                        </p>
                                        <p>
                                            The idea for Bluebus has stemmed from the need for simple travel solutions. Buses
                                            ...
                                            tedious processes. Bluebus aims to provide our customers with a wide range of services
                                        ...
                                        <p>
                                            As a company, Bluebus believes in engineering win-win relationships with our partners
