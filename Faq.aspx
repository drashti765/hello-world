<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Faq.aspx.cs" Inherits="Faqajax" Title="Blue Bus: Frequently asked questions" %>
            ...
            <div id="formBody">
                <div id="contentBox" style="margin: 0px 0px 20px 0px">
                    <ul>
                        ...
                        <li><a href="#q5">I don't have a credit can I still buy tickets at Bluebus? </a>
                        </li>
                        ...
                        <li><a href="#q9">Is there any other option to book tickets from Bluebus? </a></li>
                    </ul>
                </div>
                <ul>
                    <li><a id="q1" name="q1"></a><span class="orange11"><b>Do I have to pay extra when compared
                        ...
                        Bluebus does not charge anything extra when compared to the traditional way. The
                    ...
                    <li><a id="q4" name="q4"></a><span class="orange11"><b>Can I cancel the ticket?</b></span><br />
                        Yes. The tickets booked through Bluebus can be cancelled. Money is transferred back
                    ...
                    <li><a id="q5" name="q5"></a><span class="orange11"><b>I don't have a credit can I still
                        buy tickets at Bluebus? </b></span>
                        <br />
                        Yes. You don't necessarily need to have a credit card to buy tickets on Bluebus.
                        but after few month take a new process in that All you need to have is just an internet
                        bank account. You can transfer money from any of your below bank accounts to Bluebus
                        to buy tickets. </li>
                    <ul id="faqStyle2">
                    ...
                    <li><a id="q6" name="q6"></a><span class="orange11"><b>I missed the bus. Do I get refund?</b></span><br />
                        Bluebus provides 100% refund if the bus is missed due to either Bluebus or its partner
                        company's fault. However, if the bus is missed due to any other reasons not directly
                        related to Bluebus it does not provide any refund. </li>
                    ...
                    <li><a id="q9" name="q9"></a><span class="orange11"><b>Is there any other option to
                        book tickets from Bluebus? </b></span>
                        <br />
